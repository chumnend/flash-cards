...
class TestCategoryModel:
    ...
    def test_category_with_different_names(self):
        ...
        for name in names:
            category = CategoryModel(id=uuid.uuid4(), name=name, created_at=datetime.now(), updated_at=datetime.now())
            assert category.name == name

    def test_category_name_case_sensitivity(self):
        """Test category name case sensitivity."""
        category = CategoryModel(
            id=uuid.uuid4(), name="Programming", created_at=datetime.now(), updated_at=datetime.now()
        )
    ...
    def test_empty_category_name(self):
        ...
        category = CategoryModel(id=uuid.uuid4(), name="", created_at=datetime.now(), updated_at=datetime.now())
