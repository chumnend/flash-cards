...
class TestDeckViews:
    ...
    def test_feed_success(self, mock_request):
        ...
        mock_decks_data = [
            (uuid.uuid4(), "Deck 1", "Description 1", 4.5, datetime.now(), datetime.now(), "owner1", 8)
        ]
    ...
    def test_create_deck_success(self, mock_request):
        ...
        with patch('flashly.models.deck.DeckModel.save') as mock_save:
    ...
    def test_create_deck_empty_name(self, mock_request):
        ...
        mock_request.json_body = {
            "name": "",  # Empty name
            "description": "A deck with empty name"
        }
