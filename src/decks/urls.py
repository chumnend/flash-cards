...
urlpatterns = [
    ...
    path("decks/<int:pk>/delete/", views.DeleteDeck.as_view(), name="delete_deck"),
    ...
    path("decks/<int:deck_pk>/card/<int:card_pk>/delete/", views.DeleteCard.as_view(), name="delete_card"),
]
